    ...
    items: [
        ...
        },
        {
            ...
            items: [
                ...
                { text: "cast batch-mktx", link: "/cast/reference/batch-mktx" },
                { text: "cast batch-send", link: "/cast/reference/batch-send" },
                ...
                { text: "cast keychain", link: "/cast/reference/keychain" },
                { text: "cast keychain authorize", link: "/cast/reference/keychain/authorize" },
                { text: "cast keychain check", link: "/cast/reference/keychain/check" },
                { text: "cast keychain list", link: "/cast/reference/keychain/list" },
                { text: "cast keychain revoke", link: "/cast/reference/keychain/revoke" },
                { text: "cast keychain rl", link: "/cast/reference/keychain/rl" },
                { text: "cast keychain rs", link: "/cast/reference/keychain/rs" },
                { text: "cast keychain show", link: "/cast/reference/keychain/show" },
                { text: "cast keychain ss", link: "/cast/reference/keychain/ss" },
                { text: "cast keychain ul", link: "/cast/reference/keychain/ul" },
                ...
                { text: "cast tip20-token", link: "/cast/reference/tip20-token" },
                { text: "cast tip20-token create", link: "/cast/reference/tip20-token/create" },
                { text: "cast tip20-token mine", link: "/cast/reference/tip20-token/mine" },
